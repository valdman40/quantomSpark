import type { SystemStats } from '../../../../types/home';
...
export function SystemStatus({ stats }: Props) {
  const metrics = [
    { label: 'CPU Usage',    value: stats.cpuPercent,    color: stats.cpuPercent > 80 ? 'var(--red)' : 'var(--brand)' },
    { label: 'Memory Usage', value: stats.memoryPercent, color: stats.memoryPercent > 85 ? 'var(--red)' : 'var(--blue)' },
    { label: 'Disk Usage',   value: stats.diskPercent,   color: stats.diskPercent > 90 ? 'var(--red)' : 'var(--green)' },
  ];
